...
postJobbtn=Button(root,bd=0,text="POST A JOB",font=('Segoe UI Symbol',9,'bold'),cursor='hand2',bg="deepskyblue4",fg="white")
postJobbtn.place(x=10,y=145)

PINKpostJobbtn=Button(root,bd=0,text="POST A JOB",font=('Segoe UI Symbol',11,'bold'),cursor='hand2',bg="crimson",fg="white")
